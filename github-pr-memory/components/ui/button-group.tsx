...
function ButtonGroup({
  ...
  return (
    // shadcn layout wrapper; <fieldset> breaks styles with nested controls
    // biome-ignore lint/a11y/useSemanticElements: shadcn ButtonGroup is a styled div, not a form fieldset
    <div
      role="group"
